...
const Login = () => {
  return (
    <div className=" lg:flex items-center justify-center w-full ">
      <div className="relative flex flex-col justify-between w-full lg:w-1/2 py-12 px-6 md:px-14 h-screen bg-theme">
        <div>
      ...
      <div className="flex justify-center items-center w-full lg:w-1/2 py-12 px-6 md:px-14 xl:px-137 ">
        <div className=" w-full sm:min-w-[446px]">
          ...
          <p className="text-dark-text text-13 leading-5 mt-7">Don't have an account yet? <span className="text-green">Sign up here</span> </p>
        </div>
      </div>
    </div>
  )
