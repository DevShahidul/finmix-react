...
const Sideber = () => {
  return (
    <div className="fixed top-[115px] left-0 bg-white w-[240px] max-h-[calc(100vh-150px)] overflow-y-auto h-screen px-5 ">
      <ul>
        <li className="text-base group -ml-5 pt-1.5 pb-0.5 text-dark-body opacity-80 font-medium leading-6"><a href="index.html" className="flex items-center gap-4"><div className="pl-9 pr-4 group-hover:bg-green/15 group-hover:text-green py-2.5 rounded-r-lg-50"> {< DashboardIcon />}</div> <span className=" text-dark-body group-hover:text-dark-title">Dashboard</span> </a></li>
