...
const Checkbox = () => {
  return (
    <div className="flex items-center text-13 my-6 font-normal leading-6 text-dark-text">
        <label className="relative flex pr-4 items-center rounded-full cursor-pointer"for="checkbox"data-ripple-dark="true">
            ...
            id="checkbox" />
            <div className="absolute text-dark-text transition-opacity opacity-0 pointer-events-none top-2/4 left-1/4 -translate-y-2/4 -translate-x-2/4 peer-checked:opacity-100">
        ...
        <a className='ml-auto text-blue-50' href="index.html">Forgot Password ?</a>
    </div>
  )
}
